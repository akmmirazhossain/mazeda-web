...
const CoverageBlocks = () => {
  ...
  return (
    <section className="section_akm">
      <div className="flex items-center justify-center flex-col text-center pb-4 bg-[url('/images/coverage-page.webp')] bg-cover bg-center h-36 sm:h-52 md:h-64 lg:h-96  text-white ">
